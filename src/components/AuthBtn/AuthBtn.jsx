...
function AuthBtn({ errors, submitStatus, isSubmitting, btnText, successMessage }) {
  ...
  return (
    <div className="authbtn">
      ...
      {submitStatus && <span className="authbtn__status__success">{successMessage}</span>}
      <button type="submit" disabled={submitStatus} className={`authbtn__button__${custom}`}>
